...
class ObservationPayload(KronicableSample):
    ...
    pmra: float | None = Field(None, description="Proper motion in RA (mas/yr). Can be positive or negative.")
    pmdec: float | None = Field(None, description="Proper motion in Dec (mas/yr). Can be positive or negative.")
